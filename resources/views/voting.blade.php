                    ...
                    @else
                        ...
                        <!--<span class="login100-form-title p-b-49">
                            ...
                            @else
                                ...
                                @else
                                    <span class="d-block text-center text-black m-b-30">Select your preferred nominee and click on <b>confirm</b> to vote</span>
                                @endif
